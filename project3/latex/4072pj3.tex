...
雙連桿懸掛相比，霍斯特連桿系統的較長連桿通常會提供更平滑的曲線，產品支架為RAAW Madonna的MADONNA V1 - FAST AND PREDICTABLE，如圖(2.5)，產品為 Canyon Spectral的Izzo Pro Race 29，如圖(2.6)。}
    ...
    \end{figure} 
      ...
      \subsection{平面連桿機構模擬}
      \begin{itemize} 
      \item Python-Solvespace：Python-Solvespace以Cython編寫為核心
      \item Pyslvs：以SketchSolve由Cython編寫為核心，其中包括平面機構的創新設計方法。
      	\end{itemize} 
...
if py_nm=='36w':
    ...
    {\begin{textblock}{15}(3.5,1.2) %{寬度}(以左上角為原點之右移量,下移量)
	\fourteen \makebox[4em][s]{姓名}\enspace:\enspace
    ...
    \end{textblock}}
    {\renewcommand\baselinestretch{0.99}\selectfont %設定以下行距
    {\begin{textblock}{15}(3.5,4.8) %{寬度}(以左上角為原點之右移量,下移量)
    \noindent \kaishu \fourteen \makebox[4em][s]{姓名}\enspace:\enspace
    ...
    \end{textblock}}
    {\renewcommand\baselinestretch{0.99}\selectfont %設定以下行距
    {\begin{textblock}{15}(3.5,6.6) %{寬度}(以左上角為原點之右移量,下移量)
    \noindent \kaishu \fourteen \makebox[4em][s]{姓名}\enspace:\enspace
    ...
    \end{textblock}}
    \renewcommand\baselinestretch{0.99}\selectfont %設定以下行距
    {\begin{textblock}{15}(3.5,8.4) %{寬度}(以左上角為原點之右移量,下移量)
    \noindent \kaishu \fourteen \makebox[4em][s]{姓名}\enspace:\enspace
